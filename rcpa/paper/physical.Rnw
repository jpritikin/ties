...
consequents of flow.
Subjects unaware of flow theory may
accidentally experience flow.
We contend that the frequency of these accidents
are, in part, modulated by activity flow propensity.
...
Null hypothesis \#2 is that antecedent items are not positively
correlated to items measuring phenomenological indicators and consequents.
