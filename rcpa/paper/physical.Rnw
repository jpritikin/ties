...
The primary focus has been the person who experienced flow.
...
Therefore, we rely on relative comparisons.

We can regard our problem as similar to
...
but an interaction seems plausible.
...
This item is more objective than subjective time distortion.
...
translate into actual differences in training schedule.
...
Awareness of situational factors may constitute a productive
