...
characteristics (facets) of the activities themselves. Certainly personal
...
As of April, \Sexpr{length(mask)} distinct activities were named
in comparisons by \Sexpr{sum(demogr[['again']]=='')} participants.
