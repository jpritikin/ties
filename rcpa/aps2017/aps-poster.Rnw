...
In addition to skills-demands compatibility, clear goals, and
immediate feedback,
an assortment of other likely flow triggers were included \cite{kotler2014,sawyer2007,wegner2002}.
Item prompts follow:
%
\begin{itemize}[noitemsep]
\item   How much skill is required?
\item   How predictable is the action?
\item   To what extent do you find new and fresh experiences during the activity?
\item   To what extent are there opportunities to express creativity during the activity?
\item   How complex is the action and the environment in which it takes place?
\item   How clear and straightforward are the short-term rules and goals?
\item   How quickly do you know whether what you wanted to accomplish in the short term was successful?
\item   How clear and straightforward are the long-term rules and goals?
\item   How quickly do you know whether what you wanted to accomplish in the long term was successful?
\item   Does your extraneous mental chatter temporarily shut down during the activity?
\item   How much time do you feel like is spent waiting for the next step in the activity?
\item   How much of your body is involved in the activity? Is it full-body or only part of your body?
\item   How much control do you feel like you can exert over your performance?
\item   During the activity, to what extent do you feel like you are in the present moment?
\item   How spontaneous is your action?
\item   During the activity, how important does the activity feel?
\item   To what extent do you care about how others judge your performance?
\item   After engaging in the physical activity, to what extent do you feel great?
\item   What is the risk of minor physical injury (more than just muscle soreness)?
\item   What is the risk of serious physical injury?
\end{itemize}
...
The preliminary results page is interactive.
...
Participants are encouraged to share the weights they develop via social networks
...
mentioned by \Sexpr{sum(demogr[['again']]=='')} participants.
An additional \Sexpr{sum(demogr[['again']]=='Yes')} comparisons
were contributed by repeated participation.
Participants were mostly from USA (\Sexpr{round(100*country[1]/nrow(demogr1))}\%),
Germany (\Sexpr{round(100*country[2]/nrow(demogr1))}\%),
and United Kingdom (\Sexpr{round(100*country[3]/nrow(demogr1))}\%).
Most reported being female (\Sexpr{round(100*sex['Female']/nrow(demogr1))}\%).
Most were 25 or fewer years old (\Sexpr{round(100*age[2]/nrow(demogr1))}\%).
...
\end{align}
%
To account for a participant's expertise,
the actual model used was a bit more complex.
Some activities like \emph{walking}
involve little skill.
However, some physical activities
take many years to master.
For example, Brazilian Jiu-Jitsu often takes
seven years of practice (or more) to reach black belt.
It seems plausible that Jiu-Jitsu beginners
may experience the characteristics of the sport
differently than a black belt.
To take this into account,
participants were asked to describe themselves
as a \emph{beginner}, \emph{competent amateur},
or \emph{expert or professional} for each of the two activities.
Separate $\theta$ parameters were estimated
for each skill level,
but insufficient data were available to find
any differences.
...
to due low connectivity leaving \Sexpr{table(mask)[2]} well-connected activities.
...
\item Personal preference for activities can be treated as noise.
...
measured prevalence of flow while involved in activities.
\end{itemize}
