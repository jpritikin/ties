...
\title{Mediational analysis of meditation: \\ \smallskip The stepping stone of complete mental silence}
...
\caption{In Model 1, there is only a direct positive correlation between
the contemplative practice and the benefits. This direct correlation
...
that little research has examined effect modifiers \parencite{ospina2007}.
...
a related weakness in current intervention studies of contemplative practices.
