...
Meditation can be operationalized more specifically.
...
is typically judged insurmountable.
...
magnitude more studies \cite{lau2004}.

The hypothesis advanced here is that thoughtless awareness
has simply been overlooked.
Certainly a suppression approach to thoughtless awareness
is unworkable \cite{wegner2003},
but this is not sufficient reason to cease investigation altogether.
...
positive psychology (\citeNP{peterson2004}; \citeNP{snyder2009})?
It seems plausible that accidental thoughtless awareness
is much more common than assumed.

TODO: Link with the Oxford handbook of positive psychology
(\citeNP{shapiro2009}, etc) and Character strengths and virtues \cite{peterson2004}
