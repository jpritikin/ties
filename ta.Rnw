...
centering devices ignoring the question of whether participants are
experiencing complete mental silence.
Since ancient times, Sanskrit has distinguished these two concepts
without much difficulty.
{\dn nirvicaara samaadhI} (nirvichar samadhi) is used to denote
...
a reduction in intensity of thinking but a cessation of thinking.
As for psychological centering devices, Sanskrit literature is generally
...
Has received any training in meditation? By education \cite{baer2008}?
