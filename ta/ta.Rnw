...
I would like to thank Karen Schmidt and Steven Boker for guidance throughout this project,
Susanna Williams for helpful comments on an early draft proposal,
Jean Hu for her insight into the English language,
and Mike Kubovy for suggesting the subjective passage of time
as an amenable context.}
...
Curiously, most research using mantra or mindfulness meditation
has not dedicated sufficient consideration to the goal of meditation, that is,
complete mental silence (a.k.a. thoughtless awareness).
The notion of mental silence can be found in Hindu, Buddhist,
German mystical, and Jewish mystical traditions (\citeNP{forman1997};
\citeNP[pp.~93--102]{manocha2009}).
To approach mental silence is to reduce mental content including
re-presentations of sensory input, such as imagination.
Mental silence is an experience in which one is no longer thinking and
...
The notion of mental silence has attracted lucid discussion in artificial
intelligence, studies of consciousness, and neurophysiology
(\citeNP{fields2002}; \citeNP{forman1998}; \citeNP{ramamurthi1995}).
...
and is used mainly in the context yoga/meditation.
...
approximately, ``I am the mental silence'' (cf. \citeNP{preston1982}).
...
A curious analogy can be drawn between mental silence and
...
the experience.
Therefore, self-reports concerning the content of meditative experience
must be considered, at best, analogical and only accurate to some
limit (cf. \citeNP[p.~41]{forman1997}).\footnote{Heisenburg's
...
For example, \citeA{forman1998} advanced the terminology
``pure consciousness event'' as a label for the content
of the experience of complete mental silence.
However, it is not clear whether \emph{pure consciousness} is
an entirely accurate characterization of the experience.
``The pure consciousness event may be defined as a wakeful
but contentless (non-intentional) consciousness''
(\citeauthor{forman1998}, p.~72).
The question is, what about affect?
Some emotions are plausibly dependent on symbolic cognition \cite{occ88}.
For example, \emph{guilt} most likely clashes with mental silence.
Yet some simpler, less cognitive affects cannot be ruled out.
Is an affective, but mentally silent experience, contentless?
Instead of wrestling with such questions,
here the experience is labeled by its sufficient condition
rather than by its content.
An abundance of plausible attempts to describe the content of
mental silence are available in a recent anthology \cite{franke2007}.
...
Two reports are notable:
A recent review summarized current research on
the physiological correlates of meditation \cite{rubia2009}.
Tentative evidence suggests that skin temperature
can distinguish mental silence from rest \cite{manocha2010}.
However, the paucity of investigations into mental silence
allow for little certainly about its replicability,
effect size, and importance.

As of April 2012,
PsycNET searches for empirical research on ``mental silence''
or ``thoughtless awareness''
...
One scale asked participants to rate the amount of
inner dialog experienced recently on a 7-point Likert scale
(from \emph{none} to \emph{a great deal}) \cite{pekala1981}.
This question has a somewhat different emphasis than of interest here.
Most retrospective self-reports imply a discontinuity
between thinking and mental silence.
The 7-point Likert scale could be collapsed to a dichotomous response,
but this would offer little insight into the mental silence experience.
...
Another measure asked people to read descriptions of experiences,
...
\noindent Narratives like this, while intriguing, offer almost no information
...
\subsection{Survey refinement during pilot}

The survey was developed by the principle investigator
drawing on his considerable personal experience.
He has taught Sahaja Meditation for about 3 years and
practiced meditation for more than 15 years.

re-framed in the context of subjective passage of time to reduce
demand characteristics and provide a plausible contrasting anchor to
mental silence

Since some people are unfamiliar with the notion of mental silence,
it was necessary to define the conditions of this experience at
the beginning of the survey.
The description of mental silence were revised a number of times.
Some participants expressed the opinion that mental silence was
compatible with daydreaming. To counter this misunderstanding,
re-presentations of sensory input (e.g. imagination) was explicitly
ruled out.
Some participants speculated that the conditions of mental silence
ruled out life itself.
To counter this misunderstanding,
physical movement, sensory input, and affective states were explicitly
mentioned as compatible with mental silence.

``The idea of complete mental silence does not make sense.''
